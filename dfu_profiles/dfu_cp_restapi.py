...
a Cloud Data Fusion instance using the REST API. It reads the configuration from 
a JSON file in the specified directory and creates or updates the profile in Data Fusion.
